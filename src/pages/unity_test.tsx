...
export default function Protected(props: any) {
  const { unityProvider, addEventListener, removeEventListener, sendMessage } = useUnityContext({
    ...
    loaderUrl: "unitybuild/2022.3/myunityapp.loader.js",
    dataUrl: "unitybuild/2022.3/myunityapp.data",
    frameworkUrl: "unitybuild/2022.3/myunityapp.framework.js",
    codeUrl: "unitybuild/2022.3/myunityapp.wasm",
    streamingAssetsUrl: "unitybuild/2022.3/streamingassets",
